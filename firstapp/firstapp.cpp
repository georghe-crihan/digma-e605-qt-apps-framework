...
// Originally found in QT distribution under demos/embedded/digiflip
...
#include "firstapp.moc"

int main(int argc, char *argv[])
{
    framebuffer_descriptor = open("/dev/fb0", O_RDWR); /* Open the framebuffer */
#if 0
    if (framebuffer_descriptor == 0)
    {
        Qt_error_message("eView error: \n"
			 "Unable to open /dev/fb0 - display won't refresh! Please contact the developer to try to fix it"
        );
    }
#endif

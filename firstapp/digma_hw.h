...
#define QT_REFRESH_DELAY  550000000 /*0.55 seconds*/
//#define GTK_REFRESH_DELAY 400000000 /*0.4  seconds*/
...
typedef struct { } struct_panel;

inline void TRACE(const char *format __attribute__((__unused__)), ...) { }
